    ...
    return (
      <div>
        ...
        <div hidden={!this.state.creatingActivity}>
          <CreateActivityForm ItineraryId={this.props.itineraryId} day={this.props.day} date={this.props.date} length={this.props.activities.length} toggleCreateActivityForm={() => this.toggleCreateActivityForm()} />
        </div>
      </div>
    )
  }
